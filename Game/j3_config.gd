...
func _ready():
	get_node("VBoxContainer/HBoxContainer/n_img").value = Configuracoes.j1_qtd_baterias
	get_node("VBoxContainer/HBoxContainer2/categoria").value = Configuracoes.j1_qtd_letras_bateria
